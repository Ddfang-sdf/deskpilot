...
| 状态 | **已关闭**(2026-09-22 验收通过:vision_note指引+ocr_items+默认无键;sdfang 缺席授权自决,证据见 手工测试计划-20260922-批次②积压验收 X1) |
...
| v0.3 | 2026-09-22 | **验收通过关单**(sdfang 离场留言授权自决,记录在案)。证据:手工测试计划-20260922-批次②积压验收 X1,vision_note 指引+ocr_items+默认无键 |
