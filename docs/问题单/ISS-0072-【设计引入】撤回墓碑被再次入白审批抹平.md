...
| 状态 | **已关闭**(2026-09-23 验收通过:撤回确认窗点击移出→removed=true+墓碑落盘→launch 零弹窗 REVOKED_BY_HUMAN 文案逐字直出;授权自决) |
...
| v0.7 | 2026-09-23 | **验收通过关单**(sdfang 离场留言授权自决,记录在案)。证据:撤回确认窗点击移出→removed=true+墓碑落盘→launch 零弹窗 REVOKED_BY_HUMAN 文案逐字直出 |
